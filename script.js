...
//  let randomSon = Math.floor(Math.random()  *510) + 12;
// alert(randomSon)
...
// function marsitSchoolniChiqar(){
//     for (let i = 1; i <= 10; i++){
//         console.log('MARS IT SCHOOL')
//     } 
// }
// marsitSchoolniChiqar();
...
// let harflar = ["a", "b", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "x", "y", "z"];
// let ism = harflar[17] + harflar[0] + harflar[12] + harflar[8] + harflar[0] + harflar[16]; // s + a + n + j + a + r
// console.log(ism); 
...
// yosh = Number(yosh); // kiritilgan qiymatni raqamga aylantirish
// if (yosh > 18) {
...
// console.log("Ismingiz teskari:", teskari);
...
// const result = ["ism:", savol]
// result.forEach((javob) => {
//     console.log(javob)
//     wrapper.innerHTML = `
//         ${ "ism:", javob}
//     ` 
...
//   return son % 2 === 0;
// });
// juftSonlar.forEach(function(son) {
//   console.log(son);
// });
